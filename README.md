...
### 描画システムのポイント
- Pygameの**Surface**をベースに、毎フレーム全エンティティを再描画。
...
このPygame版Pac-Manは、**エンティティ駆動・状態遷移・Ghostの行動パターン分離**という3点を軸にした設計です。  
その結果、**描画・入力・ステート管理**が適切に分離され、  
機能追加やAI強化にも耐える柔軟な構造になっています。（※まだ発展途上です。）
